...
#define backlightOn() I2C_SendByteByADDR(portlcd |= 0x08, 0b01001110) // turn the back light on
#define backlightOff() I2C_SendByteByADDR(portlcd &= ~0x08, 0b01001110) // turn the back light off
